...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
        sendInputData, sendKbm, requestPointerLock, handleTabletEvent,
        toggleTouch, toggleGyro, requestHID, handleHIDReport,
        getSafeGamepadId, lookupCalibMap, applyCalibration,
        activateGamepad, startEyeTracking, stopEyeTracking, onFaceMeshResults,
        pollGamepad, maybeShowVRButton, startVRSession, onXRFrame,
    };
}
