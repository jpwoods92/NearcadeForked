...
function _handleKbm(msg) {
    ...
    const layout = { keys: flatKeys, mouse: { sensitivity: sharedState.kbmBindings?.right_stick_multiplier ? sharedState.kbmBindings.right_stick_multiplier / 1000 : 1.5, deadzone: 0.1 } };
